...
use ryzerbe\training\minigame\type\aimtrainer\entity\AimTrainerEntity;
use ryzerbe\training\minigame\type\aimtrainer\generator\AimTrainerGenerator;
use ryzerbe\training\minigame\type\aimtrainer\item\AimTrainerConfigurationItem;
use ryzerbe\training\minigame\type\aimtrainer\item\AimTrainerResetItem;
...
class AimTrainerMinigame extends Minigame {
    ...
    public function onLoad(Session $session): void{
        ...
        CustomItemManager::getInstance()->getCustomItemByClass(AimTrainerConfigurationItem::class)?->giveItem($player, MinigameDefaultSlots::SLOT_CONFIGURATION_ITEM);
